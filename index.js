...
function init() {
    ...
    // Particulars
    var gmaterial = new THREE.MeshToonMaterial({ color: 0x00fff6, side: THREE.DoubleSide });
...
// Grid Helper
var gridHelper = new THREE.GridHelper(60, 120, 0x00fff6, 0x000000);
city.add(gridHelper);

// Cars World
var createCars = function (cScale = 2, cPos = 20, cColor = 0x8400ff) {
